...
sources = {
    ...
    'cadical300': (
        'https://github.com/arminbiere/cadical/archive/refs/tags/rel-3.0.0.tar.gz',
        'solvers/cadical300.tar.gz'
    ),
    'gluecard30': (
...
to_move = {
    ...
    'cadical300': [
        ...
        ('src/lidruptracer.hpp', 'lidruptracer.hpp'),
        ('src/random.h', 'random.h'),
        ('src/stable.cpp', 'stable.cpp'),
        ('src/stack.h', 'stack.h'),
        ('src/sweep.cpp', 'sweep.cpp'),
        ('src/sweep.hpp', 'sweep.hpp'),
        ('src/testing.hpp', 'testing.hpp'),
        ('src/tier.cpp', 'tier.cpp'),
        ('src/unstable.cpp', 'unstable.cpp'),
        ('src/walk.hpp', 'walk.hpp'),
        ('src/walk_full_occs.cpp', 'walk_full_occs.cpp'),
        ('src/warmup.cpp', 'warmup.cpp'),
    ],
    'gluecard30': [],
    'gluecard41': [],
    'glucose30': [],
