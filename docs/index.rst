...
The PySAT toolkit has five core modules: :mod:`.card`, :mod:`.formula`,
:mod:`.pb`, :mod:`.process` and :mod:`.solvers`. The four of them
(:mod:`.card`, :mod:`.pb`, :mod:`.process` and :mod:`.solvers`) are Python
wrappers for the code originally implemented in the C/C++ languages while the
:mod:`.formula` module is a *pure* Python module. Version *0.1.4.dev0* of
PySAT brings a new module called :mod:`.pb`, which is a wrapper for the basic
functionality of a third-party library `PyPBLib
